...
export default function Home() {
  ...
  // Bridge parallax effect
  useEffect(() => {
    const handleParallax = () => {
      const scrolled = window.scrollY
      const desktopBridge = document.getElementById('desktop-bridge-bg')
      const mobileBridge = document.getElementById('mobile-bridge-bg')

      if (desktopBridge) {
        // Subtle parallax - moves slower than scroll (0.3 speed)
        desktopBridge.style.transform = `translateY(${scrolled * 0.3}px)`
      }

      if (mobileBridge) {
        // Subtle parallax for mobile
        mobileBridge.style.transform = `translateY(${scrolled * 0.3}px)`
      }
    }
  ...
  return (
    <>
      ...
      >
        {/* White Background for Both Desktop and Mobile */}
        <div style={{
          position: 'absolute',
          top: 0,
          left: 0,
          ...
          {!isMobile ? (
            <div style={{
              ...
              {/* Bridge Image Background with Parallax for Desktop */}
              <div
                id="desktop-bridge-bg"
                style={{
                  position: 'absolute',
                  bottom: 0,
                  left: 0,
                  width: '100%',
                  height: '100%',
                  backgroundImage: 'url(/Brigdge.jpeg)',
            ...
            <div style={{
              ...
              {/* Bridge Image Background with Parallax for Mobile */}
              <div
                id="mobile-bridge-bg"
                style={{
                  position: 'absolute',
